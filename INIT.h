 ...
 *-------------------------------------------------------------------------*/
	...
	* |_________________________|___________________________________________________|		*
	...
	#define __T1_TIME	10000
		...
		#define __I2C_BRG	  	17
		#define __U1BRG			207
		#define __T1_TIME		40000
		#define __T3_TIME		6
	#endif
	#ifdef PLL_8
		#define __I2C_BRG	  	35
		#define __U1BRG			103
		#define __T1_TIME		20000
		#define __T3_TIME		9
	#endif
	#ifdef PLL_4
		#define __I2C_BRG	  	17
		...
		#define __I2C_BRG	  	16
		#define __U1BRG			11
		#define __T1_TIME		2313
		#define __T3_TIME		264
	#endif
	#ifdef INTERNAL_OSC_PLL8
		#define __I2C_BRG	  	19
		#define __U1BRG			95
		#define __T1_TIME		18500
		#define __T3_TIME		1057
	#endif
	#ifdef INTERNAL_OSC_PLL16
		#define __I2C_BRG	  	19
		#define __U1BRG			191
		#define	__T1_TIME		37000
		#define __T3_TIME		2114
	#endif
	...
	#define DDR_LED_AUTOPLUS	TRISCbits.TRISC2					//	Toggle Error Status LED on LED Board							
	...
	#define LED_AUTOPLUS		LATCbits.LATC2			
	/***************************Manual Key***********************************************/
	...
	#define SNS_MODE	0		// "0" - RYB_VOLT_SENSOR_MODE and "1" - RYB_IO_SENSOR_MODE	
//
//	#define	R_PHASE_PIN				PORTGbits.RG13
//	#define	Y_PHASE_PIN				PORTGbits.RG12
//	#define	B_PHASE_PIN				PORTGbits.RG0
//
	#if	(SNS_MODE)							// "0" - RYB_VOLT_SENSOR_MODE and "1" - RYB_IO_SENSOR_MODE	
		#define	RYB_IO_SENSOR_MODE			// RYB power sensing by input lines (digital IO's)
	#else
		#define RYB_VOLT_SENSOR_MODE		// RYB power sensing by adc lines
	#endif
